...
dz = 0.1*sqrt(2*Dz*dt);  % z displacement (epsilon Z)

% particle initialization
x = 10*unifrnd(0,600,1,t*emitted); %Xn
...
xlim([ymin,ymax])  %Setting border limits in x direction
ylim([zmin,zmax]) %Setting border limits in y direction
