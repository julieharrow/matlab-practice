...
totalTime = 1:dt:(500 * 365 * 24 * 60 * 60);    %seconds
...
lapseRate = (T_S(end) - T_L(end))/h_L;      %K/m
...
title('Temperatures Over 500 Years (Nominal Case)')
xlabel('Time (seconds)')
ylabel('Temperatuer (Kelvin)')
legend('T_U = 251.2K','T_L = 280.5K','T_S = 290.3K')
text(1.5*10^9,270, 'Steady State Temperatures:')
